<template>
  ...
  <br>
  <button @click="cross">跨域请求</button>
  <br>
  <button @click="mock">mock获取用户列表</button>
  <br>
  <button @click="mock2">mock获取用户</button>
  <br>
  <button @click="mock3">mock获取用户2</button>
  <br>
  <button @click="mock4">mock新增用户</button>
  <br>
  <button @click="mock5">mock修改用户</button>
  <br>
  <button @click="mock6">mock删除用户</button>
</template>
...
// mock新增用户
function mock4() {
  axios.post('/mk/user', {name: 'test', email: 'a@b.c', phone: 123}).then(res => {
    console.log(res.data)
  }).catch(err => {
    console.log(err)
  })
...
// mock修改用户
function mock5() {
  axios.patch('/mk/user', {id: '1234', name: 'test', email: 'a@b.c', phone: 123}).then(res => {
    console.log(res.data)
  }).catch(err => {
    console.log(err)
  })
...
// mock删除用户
function mock6() {
  axios.delete('/mk/user/123').then(res => {
    console.log(res.data)
  }).catch(err => {
    console.log(err)
  })
